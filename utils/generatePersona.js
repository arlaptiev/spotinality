...
import { getStory, getTitle, getBackgroundPic, requestPersonaPic } from "./promptGen"
...
export const generatePersona = async () => {
  ...
  try {
    ...
    const artists = labels.rec_names_of_tr
    ...
    const backgroundPicUrls = await getBackgroundPic(story, labels)
    const backgroundPicUrl = backgroundPicUrls[0]

    const persona = { title, story, backgroundPicUrl, backgroundPicUrls, personaPicUrl, artists }
    ...
    //   "artists": labels.rec_names_of_tr
    // }

    // const persona = {
    //   "title": "Indie Soul Fanatic",
    ...
    //   "backgroundPicUrls": ["https://storage.googleapis.com/data-collective-images/arlaptiev%40gmail.com/exhibits/text-to-image/a0105512-4f3c-4982-b7cf-6353affbfbe8.png?X-Goog-Algorithm=GOOG4-RSA-SHA256&X-Goog-Credential=vana-app-user%40corsali-production.iam.gserviceaccount.com%2F20230127%2Fauto%2Fstorage%2Fgoog4_request&X-Goog-Date=20230127T023752Z&X-Goog-Expires=86401&X-Goog-SignedHeaders=host&X-Goog-Signature="],
    //   "artists": 'Bluhbluh, Pipiu, Wowowo'
    // }
